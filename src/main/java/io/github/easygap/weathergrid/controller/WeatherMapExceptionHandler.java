...
/** Stable text error contract for the map data APIs. */
@RestControllerAdvice(assignableTypes = {
        WeatherGridController.class,
        WeatherLocationController.class
})
public final class WeatherMapExceptionHandler {
